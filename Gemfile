...
# every generated gemfiles/*.gemfile, and those run across a Ruby matrix (2.7 for
# Jekyll 3.0–3.7, 3.3 for Jekyll 3.8+). See .github/workflows/ci.yml and Appraisals.
gem 'jekyll', '~> 3.8.0'
gem 'rexml'
gem 'appraisal', '~> 2.5.0'
